...
function shouldSkip(file) {
  ...
  if (file.includes('scripts' + path.sep + 'generate_simple_tests.js')) return true;
...
for (const file of files) {
  ...
  const testContent = `import * as mod from '${importPath}';

describe('auto-load ${relPath}', () => {
  it('can import module without throwing', () => {
