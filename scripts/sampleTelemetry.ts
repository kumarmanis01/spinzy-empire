#!/usr/bin/env node
/**
 * Sampler for TelemetrySample (Phase 5(B))
 * - Gathers minute-bucketed metrics
 * - Writes idempotent rows to TelemetrySample (ON CONFLICT DO NOTHING)
 * - Respects DB availability check; logs and exits on DB write failure
 */
...
// TODO(retention):
// - keep minute samples 30d
// - downsample hourly (avg/max/sum)
// - delete raw beyond window
